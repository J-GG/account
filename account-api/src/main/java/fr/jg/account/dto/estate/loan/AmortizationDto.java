package fr.jg.account.dto.estate.loan;

import fr.jg.account.domain.estate.loan.AmortizationFrequencyEnum;
import fr.jg.account.domain.estate.loan.AmortizationTypeEnum;
